...
libraryDependencies += "com.typesafe.play" %% "play-jdbc" % "2.9.5" // Core JDBC support
...
libraryDependencies += "org.mockito" % "mockito-core" % "5.11.0" % Test // Add Mockito for mocking
